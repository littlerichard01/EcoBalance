...
Essa análise permite estimar de forma personalizada o impacto ambiental do seu estilo de vida, promovendo uma compreensão mais clara das suas emissões e identificando oportunidades reais de redução.
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla sed libero at ipsum aliquet porta.</p>

            <div className="btn-wrapper">
              <button className="btn-cadastrar">Calcular</button>
            </div>
          </section>
          ...
          <section className="faq-section">
            ...
            <details>
              <summary>Pergunta Frequente 1</summary>
              <p>Resposta detalhada da pergunta frequente 1.</p>
            </details>
            <details>
              <summary>Pergunta Frequente 2</summary>
              <p>Resposta detalhada da pergunta frequente 2.</p>
            </details>
            <details>
              <summary>Pergunta Frequente 3</summary>
              <p>Resposta detalhada da pergunta frequente 3.</p>
            </details>
            <details>
              <summary>Pergunta Frequente 4</summary>
              <p>Resposta detalhada da pergunta frequente 4.</p>
            </details>
          </section>
        </div>
      </main>
