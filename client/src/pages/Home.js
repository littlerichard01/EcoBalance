      ...
      <main className="login-container">
        <div className="home-content">
          ...
          <div className="carousel-box">
            <div className="image-container tooltip-container">
              <img
              ...
              <div className="content-overlay">
                ...
                <div className="overlay-content-btn">
                  <button className="overlay-button" onClick={handleTesteClick}>
                    {textos[idiomaSelecionado]?.calcular}
                  </button>
                </div>
              </div>
            </div>
